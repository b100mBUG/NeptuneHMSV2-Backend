...
async def add_prescription(hospital_id: str, prescription_detail: dict):
...
async def fetch_prescriptions(hospital_id: str, sort_term: str, sort_dir: str):
    async with async_session() as session:
        stmt = (
            select(Prescription)
...
async def search_prescriptions(hospital_id: str, search_term: str):
    async with async_session() as session:
        stmt = (
            select(Prescription)
            .join(Patient)
...
async def get_specific_prescription(hospital_id: str, prescription_id: str):
    async with async_session() as session:
        stmt = (
            select(Prescription)
            .where(
...
async def delete_prescription(hospital_id: str, prescription_id: str):
    async with async_session() as session:
