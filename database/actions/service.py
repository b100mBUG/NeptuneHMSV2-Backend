...
async def add_services(hospital_id: str, service_detail: dict):
...
async def fetch_services(hospital_id: str, sort_term: str, sort_dir: str):
    async with async_session.begin() as session:
...
async def search_services(hospital_id: str, search_term: str):
    async with async_session.begin() as session:
...
async def get_specific_service(hospital_id: str, service_id: str):
    async with async_session.begin() as session:
...
async def edit_service(hospital_id: str, service_id: str, service_detail: dict):
    async with async_session.begin() as session:
        stmt = select(Service).where(
            (Service.hospital_id == hospital_id)&
            (Service.service_id == service_id)
...
async def delete_service(hospital_id: str, service_id: str):
    async with async_session.begin() as session:
