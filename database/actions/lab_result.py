...
async def add_lab_result(hospital_id: str, result_detail: dict):
...
async def fetch_lab_results(hospital_id: str, sort_term: str, sort_dir: str):
...
async def search_lab_results(hospital_id: str, search_term: str):
    async with async_session.begin() as session:
        stmt = (
...
async def get_specific_result(hospital_id: str, result_id: str):
    async with async_session.begin() as session:
        stmt = (
            select(LaboratoryResult)
            .where(
...
async def edit_lab_result(hospital_id: str, result_id: str, result_detail: dict):
    async with async_session.begin() as session:
...
async def delete_lab_result(hospital_id: str, result_id: str):
    async with async_session() as session:
