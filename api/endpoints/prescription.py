...
async def search_all_prescriptions(hospital_id: int, search_term: str):
...
async def fetch_specific_prescription(hospital_id: int, prescription_id: int):
...
async def add_prescriptions(hospital_id: int, prescription: PrescriptionsIn):
...
async def remove_prescription(hospital_id: int, prescription_id: int):
    try:
