...
async def fetch_all_diagnosis_data(hospital_id: int, sort_term: str, sort_dir: str):
...
async def search_all_diagnosiss(hospital_id: int, search_term: str):
...
async def fetch_specific_diagnosis(hospital_id: int, diagnosis_id: int):
...
async def add_diagnoses(hospital_id: int, diagnoses: DiagnosesIn):
...
async def format_diagnosis(hospital_id: int, diagnosis_id: int, data: DiagnosesEdit):
...
async def remove_diagnosis(hospital_id: int, diagnosis_id: int):
    try:
