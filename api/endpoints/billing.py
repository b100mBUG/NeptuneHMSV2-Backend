...
async def show_all_billings(hospital_id: int):
...
async def show_all_patient_billings(hospital_id: int, patient_id: int):
...
async def show_all_patient_billings_today(hospital_id: int, patient_id: int):
