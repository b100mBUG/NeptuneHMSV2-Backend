...
async def search_all_services(hospital_id: int, search_term: str):
...
async def fetch_specific_service(hospital_id: int, service_id: int):
...
async def add_service(hospital_id: int, service: ServicesIn):
...
async def format_service(hospital_id: int, service_id: int, data: ServicesEdit):
...
async def remove_service(hospital_id: int, service_id: int):
    try:
