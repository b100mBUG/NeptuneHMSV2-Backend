...
async def fetch_all_lab_result_data(hospital_id: int, sort_term: str, sort_dir: str):
...
async def search_all_lab_results(hospital_id: int, search_term: str):
...
async def fetch_specific_lab_result(hospital_id: int, lab_result_id: int):
...
async def add_lab_results(hospital_id: int, lab_result: LaboratoryResultsIn):
...
async def format_lab_result(hospital_id: int, lab_result_id: int, data: LaboratoryResultsEdit):
...
async def remove_lab_result(hospital_id: int, lab_result_id: int):
    try:
