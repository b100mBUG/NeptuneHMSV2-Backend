...
async def fetch_all_lab_request_data(hospital_id: int, sort_term: str, sort_dir: str):
...
async def search_all_lab_requests(hospital_id: int, search_term: str):
...
async def fetch_specific_lab_request(hospital_id: int, lab_request_id: int):
...
async def add_lab_requests(hospital_id: int, lab_request: LaboratoryRequestsIn):
...
async def remove_lab_request(hospital_id: int, lab_request_id: int):
    try:
