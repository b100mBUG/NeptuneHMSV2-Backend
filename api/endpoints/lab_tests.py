...
async def fetch_all_lab_test_data(hospital_id: int, sort_term: str, sort_dir: str):
...
async def search_all_lab_tests(hospital_id: int, search_term: str):
...
async def fetch_specific_lab_test(hospital_id: int, lab_test_id: int):
...
async def add_lab_test(hospital_id: int, lab_test: LaboratoryTestsIn):
...
async def format_lab_test(hospital_id: int, lab_test_id: int, data: LaboratoryTestsEdit):
...
async def remove_lab_test(hospital_id: int, lab_test_id: int):
    try:
